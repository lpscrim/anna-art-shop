...
> Anna just needs to set up her account. The Connect linking happens later in live mode (Phase 2).
...
> Do this once Anna's account is verified. **Connect account linking only works in live mode — you cannot do this in test/sandbox mode.**

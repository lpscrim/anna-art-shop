...
export async function POST(req: NextRequest) {
  try {
    ...
    // Application fee covers Stripe's fee (up to 3.25% + 20p for international cards) plus our 1% cut (3.5% + 20p total)
    ...
    if (clientAccountId) {
      ...
      applicationFeeAmount = Math.round(totalAmount * 0.035) + 20;
    }

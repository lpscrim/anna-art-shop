  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-xs">
      <label className="block">
        ...
        <div className="relative mt-1">
          ...
          <input
            ...
            className="block w-full rounded-md border border-muted bg-background pl-7 pr-3 py-2 text-sm focus:border-foreground focus:outline-none"
          />
        </div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="px-4 py-2 rounded border border-foreground bg-foreground text-background text-sm transition-opacity hover:opacity-80 disabled:opacity-50"
      >
        {pending ? 'Saving…' : 'Save'}
      </button>
    </form>
